...
importScripts('https://cdn.jsdelivr.net/npm/firebase@7.19.0/firebase-app.js');
importScripts('https://cdn.jsdelivr.net/npm/firebase@7.19.0/firebase-messaging.js');
