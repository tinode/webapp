...
importScripts('https://cdn.jsdelivr.net/npm/firebase@7.17.1/firebase-app.js');
importScripts('https://cdn.jsdelivr.net/npm/firebase@7.17.1/firebase-messaging.js');
