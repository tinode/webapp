      ...
      <div className="scrollable-panel">
        <div className="panel-form-column">
          <a href={LINK_CONTACT_US} className="flat-button" target="_blank">
            <i className="m-icon">email</i> &nbsp;<FormattedMessage id="link_contact_us"
          ...
          <a href={LINK_TERMS_OF_SERVICE} className="flat-button" target="_blank">
            <i className="m-icon">description</i> &nbsp;<FormattedMessage id="link_terms_of_service"
          ...
          <a href={LINK_PRIVACY_POLICY} className="flat-button" target="_blank">
            <i className="m-icon">policy</i> &nbsp;<FormattedMessage id="link_privacy_policy"
