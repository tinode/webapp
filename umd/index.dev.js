...
/*!**************************!*\
  !*** ./src/lib/utils.js ***!
  \**************************/
/*! exports provided: updateFavicon, vcard, arrayEqual, asPhone, asEmail */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var PACKAGE_VERSION = "0.15.15-rc2";
    ...
    value: function render() {
      ...
      this.state.credentials.map(function (cred) {
        credentials.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: cred.meth + ":" + cred.val
        }, cred.meth, ": ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tt", null, cred.val), !cred.done ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
          href: "javascript:;",
          onClick: _this2.props.onCredConfirm.bind(_this2, cred.meth, cred.val)
        }, "confirm") : null, " ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
          href: "javascript:;",
...
var TinodeWeb = function (_React$Component) {
  ...
  _createClass(TinodeWeb, [{
    ...
    value: function handleLoginSuccessful() {
      ...
      me.subscribe(me.startMetaQuery().withLaterSub().withDesc().withTags().withCreds().build()).catch(function (err) {
        localStorage.removeItem('auth-token');
    ...
    value: function handleNewTopicRequest(peerName, pub, priv, tags) {
      ...
      this.setState({
        ...
        _this21.handleTopicSelected(topicName);
      });
    }
  }, {
      ...
      if (action == 'topic_archive') {
        if (promise && params.topicName && params.topicName == this.state.topicSelected) {
          promise.then(function () {
            _this26.handleTopicSelected(null);
          });
        }
      }
    }
    ...
    value: function handlePasswordResetRequest(method, value) {
      ...
      this.tinode.connect().then(function () {
        return _this28.tinode.requestResetAuthSecret('basic', method, value);
      }).catch(function (err) {
    ...
    value: function handleResetPassword(scheme, newPassword, token) {
      ...
      if (!token) {
        ...
        this.tinode.connect().then(function () {
          return _this29.tinode.updateAccountBasic(null, null, newPassword, {
            token: token
          });
        }).catch(function (err) {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        onTopicRemoved: function onTopicRemoved(topicName) {
          if (topicName == _this30.state.topicSelected) {
