    ...
    _this.MenuItems = {
      ...
      'topic_archive': {
        ...
        handler: function handler(params, errorHandler) {
          ...
          topic.archive(true).catch(function (err) {
            if (errorHandler) {
              errorHandler(err.message, 'err');
            }
          });
