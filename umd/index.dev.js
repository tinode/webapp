...
var TinodeWeb = function (_React$Component) {
  ...
  _createClass(TinodeWeb, [{
    ...
    value: function defaultTopicContextMenu(topicName) {
      ...
      } : null, subscribed ? 'messages_clear' : null, subscribed && deleter ? 'messages_clear_hard' : null, subscribed ? muted ? 'topic_unmute' : 'topic_mute' : null, subscribed ? blocked ? 'topic_unblock' : 'topic_block' : null, subscribed && !topic.isArchived() ? 'topic_archive' : null, 'topic_delete'];
    }
  }, {
