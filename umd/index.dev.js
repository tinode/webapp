...
/* harmony export */ });
const PACKAGE_VERSION = "0.20.0-beta3";
...
class TinodeWeb extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  defaultTopicContextMenu(topicName) {
    ...
    } : null, subscribed && tinode_sdk__WEBPACK_IMPORTED_MODULE_4__.Tinode.isP2PTopicName(topicName) ? {
...
class CallMessage extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  render() {
    ...
    const duration = isCallDropped ? this.props.incoming ? this.props.callState == 'declined' ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_intl__WEBPACK_IMPORTED_MODULE_1__.FormattedMessage, {
      id: "call_declined",
      defaultMessage: [{
        "type": 0,
        "value": "declined"
