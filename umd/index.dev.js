...
class AvatarCropView extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  ...
  handleSubmit() {
    ...
    (0,_lib_blob_helpers_js__WEBPACK_IMPORTED_MODULE_3__.imageCrop)(this.props.mime, this.props.avatar, this.state.top, this.state.left, this.state.width, this.state.height, this.state.scale, (mime, blob, width, height) => {
...
class Cropper extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  mouseUp(e) {
    ...
    this.props.onChange(-this.state.panX + this.cutoutRect.left - this.bBoxRect.left, -this.state.panY + this.cutoutRect.top - this.bBoxRect.top, this.cutoutRect.width / this.state.zoom, this.cutoutRect.height / this.state.zoom, this.state.zoom);
  }
