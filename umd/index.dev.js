...
class Contact extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    ...
    if (this.props.previewIsVideoCall) {
      ...
      }, this.props.previewIsResponse ? 'call_received' : 'call_made'));
