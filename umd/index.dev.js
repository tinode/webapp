...
/* harmony export */ });
const PACKAGE_VERSION = "0.20.0-alpha1";
...
class CallMessage extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  render() {
    ...
    const callIcon = this.props.response ? isCallDropped ? 'call_missed' : 'call_received' : isCallDropped ? 'call_missed_outgoing' : 'call_made';
    const duration = isCallDropped ? this.props.response ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_intl__WEBPACK_IMPORTED_MODULE_1__.FormattedMessage, {
      id: "call_missed",
      defaultMessage: [{
        "type": 0,
        "value": "missed"
    ...
    }, react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, this.props.response ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_intl__WEBPACK_IMPORTED_MODULE_1__.FormattedMessage, {
      id: "calls_incoming",
      defaultMessage: [{
        "type": 0,
        "value": "Incoming call"
