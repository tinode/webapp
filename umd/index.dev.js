...
var PACKAGE_VERSION = "0.15.13-rc3";
...
var MessagesView = function (_React$Component) {
  ...
  _createClass(MessagesView, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      var val = nextProps.acs ? !nextProps.acs.isWriter() : true;
...
var TinodeWeb = function (_React$Component) {
  ...
  function TinodeWeb(props) {
    ...
    _this.handleNewChatInvitation = _this.handleNewChatInvitation.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(TinodeWeb, [{
    ...
    value: function defaultTopicContextMenu(topicName) {
      ...
      } : null, subscribed ? 'messages_clear' : null, subscribed && deleter ? 'messages_clear_hard' : null, muted ? 'topic_unmute' : 'topic_mute', blocked ? 'topic_unblock' : 'topic_block', !archived ? 'topic_archive' : null, 'topic_delete'];
    }
  }, {
