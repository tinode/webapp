...
class TinodeWeb extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    ...
    }) : null, this.state.callTopic && this.state.callState == _constants_js__WEBPACK_IMPORTED_MODULE_13__.CALL_STATE_INCOMING_RECEIVED ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_widgets_call_incoming_jsx__WEBPACK_IMPORTED_MODULE_9__["default"], {
      tinode: this.tinode,
...
class IncomingCallView extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    }, (0,_lib_utils_js__WEBPACK_IMPORTED_MODULE_7__.clipStr)(this.state.fullName, _config_js__WEBPACK_IMPORTED_MODULE_4__.MAX_PEER_TITLE_LENGTH))), react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      className: "controls"
    }, this.props.callState == _constants_js__WEBPACK_IMPORTED_MODULE_5__.CALL_STATE_INCOMING_RECEIVED ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      className: "danger",
...
class CallMessage extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  render() {
    ...
    const duration = isCallDropped ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_intl__WEBPACK_IMPORTED_MODULE_1__.FormattedMessage, {
      id: "call_cancelled",
      defaultMessage: [{
        "type": 0,
        "value": "cancelled"
      }],
      dexcription: "Label for cancelled call, incoming or outgoing"
  ...
  render() {
    ...
    if (this.props.previewIsVideoCall) {
      preview = react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, react__WEBPACK_IMPORTED_MODULE_0___default().createElement("i", {
        className: "material-icons"
      }, this.props.previewIsResponse ? 'call_received' : 'call_made'), react__WEBPACK_IMPORTED_MODULE_0___default().createElement("i", {
        className: "material-icons"
      }, "video_call"));
