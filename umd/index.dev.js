...
var PACKAGE_VERSION = "0.16.0-rc1";
  ...
  _createClass(TinodeWeb, [{
    ...
    value: function handlePasswordResetRequest(method, value) {
      ...
      this.tinode.connect().then(function () {
        return _this29.tinode.requestResetAuthSecret('basic', method, value);
      }).catch(function (err) {
    ...
    value: function handleResetPassword(scheme, newPassword, token) {
      ...
      if (!token) {
        ...
        this.tinode.connect().then(function () {
          return _this30.tinode.updateAccountBasic(null, null, newPassword, {
            token: token
          });
        }).catch(function (err) {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        onTopicRemoved: function onTopicRemoved(topicName) {
          if (topicName == _this31.state.topicSelected) {
            _this31.handleTopicSelected(null);
          }
        },
