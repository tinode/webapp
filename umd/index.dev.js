...
/* WEBPACK VAR INJECTION */(function(global) {!function (e) {
  ...
  var e = function (e) {
    ...
    function r(e, t) {
      ...
      try {
        for (var i = (n = atob(e)).length, s = new ArrayBuffer(i), r = new Uint8Array(s), o = 0; o < i; o++) r[o] = n.charCodeAt(o);

        return URL.createObjectURL(new Blob([s], {
          type: t
        }));
      } catch (a) {
        console.log("Drafty: failed to convert object.", a.message);
      }
    ...
    var o = {
      ...
      IM: {
        open: function (e) {
          var t = r(e.val, e.mime),
              n = e.ref ? e.ref : t;
          return (e.name ? '<a href="' + n + '" download="' + e.name + '">' : "") + '<img src="' + t + '"' + (e.width ? ' width="' + e.width + '"' : "") + (e.height ? ' height="' + e.height + '"' : "") + ' border="0" />';
        },
        close: function (e) {
          return e.name ? "</a>" : "";
        },
        props: function (e) {
          return e ? {
            ...
            "data-name": e.name,
            "data-size": e.val ? .75 * e.val.length | 0 : 0,
            "data-mime": e.mime
          } : null;
        }
      },
    ...
    a.parse = function (e) {
      ...
      t.map(function (e) {
        var t,
            ...
            c = [];
        if (n.map(function (t) {
          c = c.concat(function (e, t, n, i) {
            for (var s = [], r = 0, o = e.slice(0); o.length > 0;) {
              var a = t.exec(o);
              if (null == a) break;
              var c = a.index + a[0].lastIndexOf(a[1]);
              o = o.slice(c + 1), r = (c += r) + 1;
              var u = n ? n.exec(o) : null;
              if (null == u) break;
              var h = u.index + u[0].indexOf(u[1]);
              o = o.slice(h + 1), r = (h += r) + 1, s.push({
                text: e.slice(c + 1, h),
                children: [],
                start: c,
                end: h,
          ...
          c.sort(function (e, t) {
            ...
            for (var n = [t[0]], i = t[0], s = 1; s < t.length; s++) t[s].start > i.end ? (n.push(t[s]), i = t[s]) : t[s].end < i.end && i.children.push(t[s]);

            for (var s in n) n[s].children = e(n[s].children);
          ...
          var u = function e(t, n) {
            ...
            for (var r in t) {
              ...
              if (!o.text) {
                var a = e(o.children, i.length + n);
                o.text = a.txt, s = s.concat(a.fmt);
              }
            ...
            for (var o in s) {
              var a = s[o];
              a.start > n && r.push({
                text: t.slice(n, a.start)
              });
              var c = {
                type: a.type
              },
                  u = e(t, a.start + 1, a.end, a.children);
              u.length > 0 ? c.children = u : c.text = a.text, r.push(c), n = a.end + 1;
            }
        ...
        if ((t = function (e) {
          ...
          for (var l in t) {
            var d = t[l],
                f = r[d.unique];
            f || (f = s.length, r[d.unique] = f, s.push({
              tp: d.type,
              data: d.data
            })), h.push({
              at: d.offset,
      ...
      if (o.length > 0) {
        a.txt = o[0].txt, a.fmt = (o[0].fmt || []).concat(o[0].ent || []);
        ...
        for (var c = 1; c < o.length; c++) {
          ...
          a.fmt.push({
            ...
            len: 1,
            at: h - 1
          }), a.txt += " " + u.txt, u.fmt && (a.fmt = a.fmt.concat(u.fmt.map(function (e) {
            return e.at += h, e;
          }))), u.ent && (a.fmt = a.fmt.concat(u.ent.map(function (e) {
            return e.at += h, e;
          })));
        }

        0 == a.fmt.length && delete a.fmt, s.length > 0 && (a.ent = s);
      }

      return a;
    }, a.insertImage = function (e, t, n, i, s, r, o, a, c) {
      return (e = e || {
        txt: " "
      }).ent = e.ent || [], e.fmt = e.fmt || [], e.fmt.push({
        at: t,
        len: 1,
        key: e.ent.length
      }), e.ent.push({
    ...
    }, a.appendImage = function (e, t, n, i, s, r, o, c) {
      return (e = e || {
        txt: ""
      }).txt += " ", a.insertImage(e, e.txt.length - 1, t, n, i, s, r, o, c);
    }, a.attachFile = function (e, t, n, i, s, r) {
      (e = e || {
        txt: ""
      }).ent = e.ent || [], e.fmt = e.fmt || [], e.fmt.push({
        at: -1,
      ...
      return r instanceof Promise && (o.data.ref = r.then(function (e) {
        o.data.ref = e;
      }, function (e) {})), e.ent.push(o), e;
    }, a.wrapAsForm = function (e, t, n) {
      return "string" == typeof e && (e = {
        txt: e
      }), e.fmt = e.fmt || [], e.fmt.push({
        at: t,
        len: n,
        tp: "FM"
      }), e;
    }, a.insertButton = function (e, t, n, i, s, r, o) {
      return "string" == typeof e && (e = {
        txt: e
      }), !e || !e.txt || e.txt.length < t + n ? null : n <= 0 || -1 == ["url", "pub"].indexOf(s) ? null : "url" != s || o ? (o = "" + o, e.ent = e.ent || [], e.fmt = e.fmt || [], e.fmt.push({
        at: t,
        len: n,
        key: e.ent.length
      }), e.ent.push({
    ...
    }, a.appendButton = function (e, t, n, i, s, r) {
      var o = (e = e || {
        txt: ""
      }).txt.length;
      return e.txt += t, a.insertButton(e, o, t.length, n, i, s, r);
    }, a.attachJSON = function (e, t) {
      return (e = e || {
        txt: ""
      }).ent = e.ent || [], e.fmt = e.fmt || [], e.fmt.push({
        at: -1,
    ...
    }, a.appendLineBreak = function (e) {
      return (e = e || {
        txt: ""
      }).fmt = e.fmt || [], e.fmt.push({
        at: e.txt.length,
        len: 1,
        tp: "BR"
      }), e.txt += " ", e;
    }, a.UNSAFE_toHTML = function (e) {
      var t,
          n,
          i,
          s = e.txt,
      ...
      for (var p in c.sort(function (e, t) {
        return t.idx == e.idx ? t.len - e.len : t.idx - e.idx;
      }), c) c[p].what && (t = s, n = c[p].idx, i = c[p].what, s = t.slice(0, n) + i + t.slice(n));
      ...
      if (i = i || "", Array.isArray(o) || (o = []), !Array.isArray(r)) {
      ...
      return a.map(function (e) {
        e.at = e.at || 0, e.len = e.len || 0, e.len < 0 && (e.len = 0), e.at < -1 && (e.at = -1);
      }), a.sort(function (e, t) {
        return e.at - t.at == 0 ? t.len - e.len : e.at - t.at;
      }), a = a.map(function (e) {
        var t,
            n = e.tp;
        return n || (e.key = e.key || 0, o[e.key] && (t = o[e.key].data, n = o[e.key].tp)), {
          tp: n = n || "HD",
          data: t,
          at: e.at,
          len: e.len
        ...
        for (var c = [], u = 0; u < r.length; u++) {
          ...
          if (!(h.at < 0)) {
            n < h.at && (c.push(o.call(a, null, void 0, t.slice(n, h.at), c.length)), n = h.at);

            for (var l = [], d = u + 1; d < r.length && r[d].at < h.at + h.len; d++) l.push(r[d]), u = d;

            var f = s[h.tp] || {};
            c.push(o.call(a, h.tp, h.data, f.isVoid ? null : e(t, n, h.at + h.len, l, o, a), c.length)), n = h.at + h.len;
          }
        }

        return n < i && c.push(o.call(a, null, void 0, t.slice(n, i), c.length)), c;
      }(i, 0, i.length, a, t, n);
    }, a.toPlainText = function (e) {
      return "string" == typeof e ? e : e.txt;
    }, a.isPlainText = function (e) {
      return "string" == typeof e || !(e.fmt || e.ent);
    }, a.hasAttachments = function (e) {
      if (e.ent && e.ent.length > 0) for (var t in e.ent) if (e.ent[t] && "EX" == e.ent[t].tp) return !0;
      return !1;
    }, a.attachments = function (e, t, n) {
      if (e.ent && e.ent.length > 0) for (var i in e.ent) e.ent[i] && "EX" == e.ent[i].tp && t.call(n, e.ent[i].data, i);
    }, a.getDownloadUrl = function (e) {
      var t = null;
      return "application/json" != e.mime && e.val ? t = r(e.val, e.mime) : "string" == typeof e.ref && (t = e.ref), t;
    }, a.isUploading = function (e) {
      return e.ref instanceof Promise;
    }, a.getPreviewUrl = function (e) {
      return e.val ? r(e.val, e.mime) : null;
    }, a.getEntitySize = function (e) {
      return e.size ? e.size : e.val ? .75 * e.val.length | 0 : 0;
    }, a.getEntityMimeType = function (e) {
      return e.mime || "text/plain";
    }, a.tagName = function (e) {
      return s[e] ? s[e].name : void 0;
    }, a.attrValue = function (e, t) {
      if (t && o[e]) return o[e].props(t);
    }, a.getContentType = function () {
  ...
  return function (e) {
    ...
    var r,
        o = t({}).version;
    "undefined" != typeof WebSocket && (r = WebSocket), "undefined" == typeof btoa && (e.btoa = function () {
      for (var e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", n = "", i = 0, s = 0, r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="; t.charAt(0 | s) || (r = "=", s % 1); n += r.charAt(63 & i >> 8 - s % 1 * 8)) {
        if ((e = t.charCodeAt(s += .75)) > 255) throw new Error("'btoa' failed: The string to be encoded contains characters outside of the Latin1 range.");
        i = i << 8 | e;
      }

      return n;
    }), "undefined" == typeof atob && (e.atob = function () {
      var e = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "").replace(/=+$/, ""),
          t = "";
      if (e.length % 4 == 1) throw new Error("'atob' failed: The string to be decoded is not correctly encoded.");

      for (var n, i = 0, s = 0, r = 0; n = e.charAt(r++); ~n && (s = i % 4 ? 64 * s + n : n, i++ % 4) ? t += String.fromCharCode(255 & s >> (-2 * i & 6)) : 0) n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(n);
    ...
    function g(e, t, n) {
      if ("object" != typeof t) {
        if (t === S.DEL_CHAR) return;
        return void 0 === t ? e : t;
      }

      if (null === t) return t;
      if (t instanceof Date) return e && e instanceof Date && !(e < t) ? e : t;
      if (t instanceof y) return new y(t);
      if (t instanceof Array) return t;

      for (var i in e && e !== S.DEL_CHAR || (e = t.constructor()), t) !t.hasOwnProperty(i) || n && n[i] || "_noForwarding" == i || (e[i] = g(e[i], t[i]));

      return e;
    }

    function v(e, t, n, i) {
      return e[t] = g(e[t], n, i), e[t];
    }

    function _() {
      var e = null;
      if ("withCredentials" in new XMLHttpRequest()) e = new XMLHttpRequest();else {
        if ("undefined" == typeof XDomainRequest) throw new Error("Browser not supported");
    ...
    function m(e, t) {
      if ("ts" === e && "string" == typeof t && t.length >= 20 && t.length <= 24) {
        var n = new Date(t);
        if (n) return n;
      } else if ("acs" === e && "object" == typeof t) return new y(t);

      return t;
    }

    function b(e, t) {
      return "string" == typeof t && t.length > 128 ? "<" + t.length + ", bytes: " + t.substring(0, 12) + "..." + t.substring(t.length - 12) + ">" : function (e, t) {
        if (t instanceof Date) t = function (e) {
          if (e && 0 != e.getTime()) {
            var t = e.getUTCMilliseconds();
            return e.getUTCFullYear() + "-" + n(e.getUTCMonth() + 1) + "-" + n(e.getUTCDate()) + "T" + n(e.getUTCHours()) + ":" + n(e.getUTCMinutes()) + ":" + n(e.getUTCSeconds()) + (t ? "." + n(t, 3) : "") + "Z";
          }

          function n(e, t) {
            return "0".repeat((t = t || 2) - ("" + e).length) + e;
          }
        }(t);else if (t instanceof y) t = t.jsonHelper();else if (null == t || !1 === t || Array.isArray(t) && 0 == t.length || "object" == typeof t && 0 == Object.keys(t).length) return;
        return t;
      }(0, t);
    }
    ...
    function w(e, t, n) {
      var i = null;
      return "http" !== t && "https" !== t && "ws" !== t && "wss" !== t || (i = t + "://", "/" !== (i += e).charAt(i.length - 1) && (i += "/"), i += "v" + a + "/channels", "http" !== t && "https" !== t || (i += "/lp"), i += "?apikey=" + n), i;
    }

    var M = function (e, t, n, i, s) {
      var o = this,
          a = e,
          c = i,
          u = t,
      ...
      function x() {
        var e = this;
        clearTimeout(M);
        var t = g * (Math.pow(2, S) * (1 + b * Math.random()));
        S = S >= v ? S : S + 1, this.onAutoreconnectIteration && this.onAutoreconnectIteration(t), M = setTimeout(function () {
          if (y("Reconnecting, iter=" + S + ", timeout=" + t), T) e.onAutoreconnectIteration && e.onAutoreconnectIteration(-1);else {
            var n = e.connect();
      ...
      function D() {
        clearTimeout(M), M = null, S = 0;
      }

      function E(e) {
        var t = null;
        e.connect = function (n) {
          return T = !1, t && t.readyState == t.OPEN ? Promise.resolve() : (n && (a = n), new Promise(function (n, i) {
            var s = w(a, c ? "wss" : "ws", u);
            y("Connecting to: ", s);
            var o = new r(s);
            o.onopen = function (t) {
              p && D(), e.onOpen && e.onOpen(), n();
            }, o.onclose = function (n) {
              if (t = null, e.onDisconnect) {
                var i = T ? d : h;
                e.onDisconnect(new Error(T ? f : l + " (" + i + ")"), i);
              }
          ...
          T = !0, t && (D(), t.close(), t = null);
        }, e.sendText = function (e) {
          if (!t || t.readyState != t.OPEN) throw new Error("Websocket is not connected");
          t.send(e);
      ...
      function A(e) {
        ...
        e.connect = function (i) {
          return T = !1, n ? Promise.resolve() : (i && (a = i), new Promise(function (i, s) {
            var r = w(a, c ? "https" : "http", u);
            y("Connecting to: ", r), (n = function n(i, s, r) {
              var o = _(),
                  a = !1;

              return o.onreadystatechange = function (c) {
                if (4 == o.readyState) if (201 == o.status) {
                  var u = JSON.parse(o.responseText, m);
                  t = i + "&sid=" + u.ctrl.params.sid, (o = n(t)).send(null), e.onOpen && e.onOpen(), s && (a = !0, s()), p && D();
                } else if (o.status < 400) e.onMessage && e.onMessage(o.responseText), (o = n(t)).send(null);else {
                  if (r && !a && (a = !0, r(o.responseText)), e.onMessage && o.responseText && e.onMessage(o.responseText), e.onDisconnect) {
                    var g = o.status || (T ? d : h),
                        v = o.responseText || (T ? f : l);
                    e.onDisconnect(new Error(v + " (" + g + ")"), g);
                  }
          ...
          T = !0, D(), i && (i.onreadystatechange = void 0, i.abort(), i = null), n && (n.onreadystatechange = void 0, n.abort(), n = null), e.onDisconnect && e.onDisconnect(new Error(f + " (" + d + ")"), d), t = null;
        }, e.sendText = function (e) {
          var n, s;
          if (n = t, (s = _()).onreadystatechange = function (e) {
            if (4 == s.readyState && s.status >= 400) throw new Error("LP sender failed, " + s.status);
          }, s.open("POST", n, !0), !(i = s) || 1 != i.readyState) throw new Error("Long poller failed to connect");
          i.send(e);
        }, e.isConnected = function () {
          return n && !0;
        }, e.transport = function () {
      ...
      "lp" === n ? A(this) : "ws" === n ? E(this) : "object" == typeof window && window.WebSocket ? E(this) : A(this), this.onMessage = void 0, this.onDisconnect = void 0, this.onOpen = void 0, this.onAutoreconnectIteration = void 0, this.logger = void 0;
    },
        S = function (e, t, n, i, s, r) {
      var o = this;
      this._appName = e || "Undefined", this._apiKey = n, this._browser = "", this._platform = r, this._hwos = "undefined", this._humanLanguage = "xx", "undefined" != typeof navigator && (this._browser = function (e, t) {
        e = e || "";
        var n = "";
        /reactnative/i.test(t) && (n = "ReactNative; ");
        var i,
            s = (e = e.replace(" (KHTML, like Gecko)", "")).match(/(AppleWebKit\/[.\d]+)/i);

        if (s) {
          for (var r = ["chrome", "safari", "mobile", "version"], o = e.substr(s.index + s[0].length).split(" "), a = [], c = function (e) {
            var t = /([\w.]+)[\/]([\.\d]+)/.exec(o[e]);
            t && a.push([t[1], t[2], r.findIndex(function (e) {
              return e == t[1].toLowerCase();
            })]);
          }, u = 0; u < o.length; u++) c(u);

          a.sort(function (e, t) {
            var n = e[2] - t[2];
            return 0 != n ? n : t[0].length - e[0].length;
          }), i = a.length > 0 ? a[0][0] + "/" + a[0][1] : s[1];
        } else i = /trident/i.test(e) ? (s = /(?:\brv[ :]+([.\d]+))|(?:\bMSIE ([.\d]+))/g.exec(e)) ? "MSIE/" + (s[1] || s[2]) : "MSIE/?" : /firefox/i.test(e) ? (s = /Firefox\/([.\d]+)/g.exec(e)) ? "Firefox/" + s[1] : "Firefox/?" : /presto/i.test(e) ? (s = /Opera\/([.\d]+)/g.exec(e)) ? "Opera/" + s[1] : "Opera/?" : (s = /([\w.]+)\/([.\d]+)/.exec(e)) ? s[1] + "/" + s[2] : (s = e.split(" "))[0];
        ...
        return n + i;
      }(navigator.userAgent, navigator.product), this._hwos = navigator.platform, this._humanLanguage = navigator.language || "en-US"), this._loggingEnabled = !1, this._trimLongStrings = !1, this._myUID = null, this._authenticated = !1, this._login = null, this._authToken = null, this._inPacketCount = 0, this._messageId = Math.floor(65535 * Math.random() + 65535), this._serverInfo = null, this._deviceToken = null, this._pendingPromises = {}, this._connection = new M(t, n, i, s, !0), this.logger = function (e) {
        if (o._loggingEnabled) {
          for (var t = new Date(), n = ("0" + t.getUTCHours()).slice(-2) + ":" + ("0" + t.getUTCMinutes()).slice(-2) + ":" + ("0" + t.getUTCSeconds()).slice(-2) + ":" + ("0" + t.getUTCMilliseconds()).slice(-3), i = arguments.length, s = new Array(i > 1 ? i - 1 : 0), r = 1; r < i; r++) s[r - 1] = arguments[r];

          console.log("[" + n + "]", e, s.join(" "));
        }
      }, this._connection.logger = this.logger, this._cache = {};

      var a = this.cachePut = function (e, t, n) {
        o._cache[e + ":" + t] = n;
      },
          l = this.cacheGet = function (e, t) {
        return o._cache[e + ":" + t];
      },
          d = this.cacheDel = function (e, t) {
        delete o._cache[e + ":" + t];
      },
          f = this.cacheMap = function (e, t) {
        for (var n in o._cache) if (e(o._cache[n], n, t)) break;
      };

      this.attachCacheToTopic = function (e) {
        e._tinode = o, e._cacheGetUser = function (e) {
          var t = l("user", e);
          if (t) return {
            user: e,
            public: g({}, t)
          };
        }, e._cachePutUser = function (e, t) {
          return a("user", e, g({}, t.public));
        }, e._cacheDelUser = function (e) {
          return d("user", e);
        }, e._cachePutSelf = function () {
          return a("topic", e.name, e);
        }, e._cacheDelSelf = function () {
          return d("topic", e.name);
        };
      };

      var p = function (e, t, n, i) {
        var s = o._pendingPromises[e];
        s && (delete o._pendingPromises[e], t >= 200 && t < 400 ? s.resolve && s.resolve(n) : s.reject && s.reject(new Error(i + " (" + t + ")")));
      },
          v = (setInterval(function () {
        var e = new Error("Timeout (504)"),
            t = new Date(new Date().getTime() - 5e3);

        for (var n in o._pendingPromises) {
          var i = o._pendingPromises[n];
          i && i.ts < t && (log("Promise expired", n), delete o._pendingPromises[n], i.reject && i.reject(e));
        }
      }, 1e3), this.getNextUniqueId = function () {
        return 0 != o._messageId ? "" + o._messageId++ : void 0;
      });

      this.initPacket = function (e, t) {
        switch (e) {
          case "hi":
            return {
              hi: {
                id: v(),
                ver: c,
                ua: o._appName + " (" + (o._browser ? o._browser + "; " : "") + o._hwos + "); " + u,
                dev: o._deviceToken,
                lang: o._humanLanguage,
                platf: o._platform
              }
            };
        ...
        t && (n = function (e) {
          ...
          return Object.keys(t).forEach(function (n) {
            "_" == n[0] ? delete t[n] : t[n] ? Array.isArray(t[n]) && 0 == t[n].length ? delete t[n] : t[n] ? "object" != typeof t[n] || t[n] instanceof Date || (e(t[n]), 0 == Object.getOwnPropertyNames(t[n]).length && delete t[n]) : delete t[n] : delete t[n];
          }), t;
        }(e);
        var i = JSON.stringify(e);
        o.logger("out: " + (o._trimLongStrings ? JSON.stringify(e, b) : i));

        try {
          o._connection.sendText(i);
        } catch (s) {
          if (!t) throw s;
          p(t, h, null, s.message);
        }

        return n;
      }, this.loginSuccessful = function (e) {
        e.params && e.params.user && (o._myUID = e.params.user, o._authenticated = e && e.code >= 200 && e.code < 300, e.params && e.params.token && e.params.expires ? o._authToken = {
          token: e.params.token,
          expires: new Date(e.params.expires)
        } : o._authToken = null, o.onLogin && o.onLogin(e.code, e.text));
      }, this._connection.onMessage = function (e) {
        if (e) if (o._inPacketCount++, o.onRawMessage && o.onRawMessage(e), "0" !== e) {
          var t = JSON.parse(e, m);
          t ? (o.logger("in: " + (o._trimLongStrings ? JSON.stringify(t, b) : e)), o.onMessage && o.onMessage(t), t.ctrl ? (o.onCtrlMessage && o.onCtrlMessage(t.ctrl), t.ctrl.id && p(t.ctrl.id, t.ctrl.code, t.ctrl, t.ctrl.text), setTimeout(function () {
            if (205 == t.ctrl.code && "evicted" == t.ctrl.text) {
              var e = l("topic", t.ctrl.topic);
              e && e._resetSub();
            } else if (t.ctrl.params && "data" == t.ctrl.params.what) {
              var n = l("topic", t.ctrl.topic);
              n && n._allMessagesReceived(t.ctrl.params.count);
            } else if (t.ctrl.params && "sub" == t.ctrl.params.what) {
              var i = l("topic", t.ctrl.topic);
              i && i._processMetaSub([]);
            }
          }, 0)) : setTimeout(function () {
            if (t.meta) {
              var e = l("topic", t.meta.topic);
              e && e._routeMeta(t.meta), t.meta.id && p(t.meta.id, 200, t.meta, "META"), o.onMetaMessage && o.onMetaMessage(t.meta);
            } else if (t.data) {
              var n = l("topic", t.data.topic);
              n && n._routeData(t.data), o.onDataMessage && o.onDataMessage(t.data);
            } else if (t.pres) {
              var i = l("topic", t.pres.topic);
              i && i._routePres(t.pres), o.onPresMessage && o.onPresMessage(t.pres);
            } else if (t.info) {
              var s = l("topic", t.info.topic);
              s && s._routeInfo(t.info), o.onInfoMessage && o.onInfoMessage(t.info);
            } else o.logger("ERROR: Unknown packet received.");
          }, 0)) : (o.logger("in: " + e), o.logger("ERROR: failed to parse data"));
        } else o.onNetworkProbe && o.onNetworkProbe();
      }, this._connection.onOpen = function () {
        o.hello();
      }, this._connection.onAutoreconnectIteration = function (e, t) {
        o.onAutoreconnectIteration && o.onAutoreconnectIteration(e, t);
      }, this._connection.onDisconnect = function (e, t) {
        for (var n in o._inPacketCount = 0, o._serverInfo = null, o._authenticated = !1, f(function (e, t) {
          0 === t.lastIndexOf("topic:", 0) && e._resetSub();
        }), o._pendingPromises) {
          var i = o._pendingPromises[n];
          i && i.reject && i.reject(e);
        }

        o._pendingPromises = {}, o.onDisconnect && o.onDisconnect(e);
      };
    };

    S.credential = function (e, t, n, i) {
      if ("object" == typeof e) {
        var s = e;
        t = s.val, n = s.params, i = s.resp, e = s.meth;
      }
    ...
    }, S.isNewGroupTopicName = function (e) {
      return "string" == typeof e && "new" == e.substring(0, 3);
    }, S.getVersion = function () {
      return c;
    }, S.setWebSocketProvider = function (e) {
      r = e;
    }, S.getLibrary = function () {
      return u;
    }, S.MESSAGE_STATUS_NONE = 0, S.MESSAGE_STATUS_QUEUED = 1, S.MESSAGE_STATUS_SENDING = 2, S.MESSAGE_STATUS_FAILED = 3, S.MESSAGE_STATUS_SENT = 4, S.MESSAGE_STATUS_RECEIVED = 5, S.MESSAGE_STATUS_READ = 6, S.MESSAGE_STATUS_TO_ME = 7, S.DEL_CHAR = "\u2421", S.prototype = {
      connect: function (e) {
      ...
      account: function (e, t, n, i, s) {
        var r = this.initPacket("acc");
        return r.acc.user = e, r.acc.scheme = t, r.acc.secret = n, r.acc.login = i, s && (r.acc.desc.defacs = s.defacs, r.acc.desc.public = s.public, r.acc.desc.private = s.private, r.acc.tags = s.tags, r.acc.cred = s.cred, r.acc.token = s.token), this.send(r, r.acc.id);
      },
      createAccount: function (e, t, n, i) {
        var s = this,
            r = this.account("new", e, t, n, i);
        return n && (r = r.then(function (e) {
          return s.loginSuccessful(e), e;
        })), r;
      },
      createAccountBasic: function (e, t, n) {
        return e = e || "", t = t || "", this.createAccount("basic", p(e + ":" + t), !0, n);
      },
      updateAccountBasic: function (e, t, n, i) {
        return t = t || "", n = n || "", this.account(e, "basic", p(t + ":" + n), !1, i);
      },
      hello: function () {
        var e = this,
            t = this.initPacket("hi");
        return this.send(t, t.hi.id).then(function (t) {
          return t.params && (e._serverInfo = t.params), e.onConnect && e.onConnect(), t;
        }).catch(function (t) {
          e.onDisconnect && e.onDisconnect(t);
        });
      },
      setDeviceToken: function (e, t) {
        var n = !1;
        return e && e != this._deviceToken && (this._deviceToken = e, t && this.isConnected() && this.isAuthenticated() && (this.send({
          hi: {
            dev: e
          }
        }), n = !0)), n;
      ...
      login: function (e, t, n) {
        var i = this,
            s = this.initPacket("login");
        return s.login.scheme = e, s.login.secret = t, s.login.cred = n, this.send(s, s.login.id).then(function (e) {
          return i.loginSuccessful(e), e;
        });
      },
      loginBasic: function (e, t, n) {
        var i = this;
        return this.login("basic", p(e + ":" + t), n).then(function (t) {
          return i._login = e, t;
        });
      },
      ...
      getAuthToken: function () {
        return this._authToken && this._authToken.expires.getTime() > Date.now() ? this._authToken : (this._authToken = null, null);
      },
      setAuthToken: function (e) {
        this._authToken = e;
      },
      subscribe: function (e, t, n) {
        var i = this.initPacket("sub", e);
        return e || (e = "new"), i.sub.get = t, n && (n.sub && (i.sub.set.sub = n.sub), n.desc && (S.isNewGroupTopicName(e) ? i.sub.set.desc = n.desc : "p2p" == S.topicType(e) && n.desc.defacs && (i.sub.set.desc = {
          defacs: n.desc.defacs
        })), n.tags && (i.sub.set.tags = n.tags)), this.send(i, i.sub.id);
      },
      leave: function (e, t) {
        var n = this.initPacket("leave", e);
        return n.leave.unsub = t, this.send(n, n.leave.id);
      },
      createMessage: function (e, t, n) {
        var i = this.initPacket("pub", e),
            r = "string" == typeof t ? s.parse(t) : t;
        return r && !s.isPlainText(r) && (i.pub.head = {
          mime: s.getContentType()
        }, t = r), i.pub.noecho = n, i.pub.content = t, i.pub;
      },
      publish: function (e, t, n) {
        return this.publishMessage(this.createMessage(e, t, n));
      },
      publishMessage: function (e) {
        return (e = Object.assign({}, e)).seq = void 0, e.from = void 0, e.ts = void 0, this.send({
          pub: e
        }, e.id);
      },
      getMeta: function (e, t) {
        var n = this.initPacket("get", e);
        return n.get = g(n.get, t), this.send(n, n.get.id);
      },
      setMeta: function (e, t) {
        var n = this.initPacket("set", e),
            i = [];
        return t && ["desc", "sub", "tags", "cred"].map(function (e) {
          t.hasOwnProperty(e) && (i.push(e), n.set[e] = t[e]);
        }), 0 == i.length ? Promise.reject(new Error("Invalid {set} parameters")) : this.send(n, n.set.id);
      },
      delMessages: function (e, t, n) {
        var i = this.initPacket("del", e);
        return i.del.what = "msg", i.del.delseq = t, i.del.hard = n, this.send(i, i.del.id);
      },
      delTopic: function (e) {
        var t = this,
            n = this.initPacket("del", e);
        return n.del.what = "topic", this.send(n, n.del.id).then(function (n) {
          return t.cacheDel("topic", e), t.ctrl;
        });
      },
      delSubscription: function (e, t) {
        var n = this.initPacket("del", e);
        return n.del.what = "sub", n.del.user = t, this.send(n, n.del.id);
      },
      delCredential: function (e, t, n) {
        if ("me" != e) throw new Error("Invalid topic for deleting credentials '" + e + "'");
        var i = this.initPacket("del", e);
        return i.del.what = "cred", i.del.cred = {
          meth: t,
          val: n
        }, this.send(i, i.del.id);
      },
      note: function (e, t, n) {
        if (n <= 0 || n >= 268435455) throw new Error("Invalid message id " + n);
        var i = this.initPacket("note", e);
        i.note.what = t, i.note.seq = n, this.send(i);
      },
      noteKeyPress: function (e) {
        var t = this.initPacket("note", e);
        t.note.what = "kp", this.send(t);
      },
      getTopic: function (e) {
        var t = this.cacheGet("topic", e);
        return !t && e && (t = "me" == e ? new D() : "fnd" == e ? new E() : new x(e), this.cachePut("topic", e, t), this.attachCacheToTopic(t)), t;
      },
      newTopic: function (e) {
        var t = new x("new", e);
      ...
      isTopicOnline: function (e) {
        var t = this.getMeTopic(),
            n = t && t.getContact(e);
        return n && n.online;
      },
      wantAkn: function (e) {
        this._messageId = e ? Math.floor(16777215 * Math.random() + 16777215) : 0;
      },
    ...
    var T = function (e) {
      ...
      var t = e._tinode.getMeTopic();

      this.contact = t && t.getContact(e.name), this.what = {};
    };

    T.prototype = {
      _get_ims: function () {
        var e = this.contact && this.contact.updated,
            t = this.topic._lastDescUpdate || 0;
        return e > t ? e : t;
      },
      ...
      withLaterData: function (e) {
        return this.withData(this.topic._maxSeq > 0 ? this.topic._maxSeq + 1 : void 0, void 0, e);
      },
      withEarlierData: function (e) {
        return this.withData(void 0, this.topic._minSeq > 0 ? this.topic._minSeq : void 0, e);
      },
      withDesc: function (e) {
        return this.what.desc = {
          ims: e
        }, this;
      },
      ...
      withSub: function (e, t, n) {
        ...
        return "me" == this.topic.getType() ? i.topic = n : i.user = n, this.what.sub = i, this;
      },
      ...
      withLaterSub: function (e) {
        return this.withSub("p2p" == this.topic.getType() ? this._get_ims() : this.topic._lastSubsUpdate, e);
      },
      withTags: function () {
        return this.what.tags = !0, this;
      },
      withCred: function () {
        return "me" == this.topic.getType() ? this.what.cred = !0 : log("Invalid topic type for MetaGetBuilder:withCreds", this.topic.getType()), this;
      },
      withDel: function (e, t) {
        return (e || t) && (this.what.del = {
          since: e,
          limit: t
        }), this;
      },
      withLaterDel: function (e) {
        return this.withDel(this.topic._maxSeq > 0 ? this.topic._maxDel + 1 : void 0, e);
      },
      build: function () {
        var e = [],
            t = this,
            n = {};
        return ["data", "sub", "desc", "tags", "cred", "del"].map(function (i) {
          t.what.hasOwnProperty(i) && (e.push(i), Object.getOwnPropertyNames(t.what[i]).length > 0 && (n[i] = t.what[i]));
        }), e.length > 0 ? n.what = e.join(" ") : n = void 0, n;
      }
    };
    ...
    y._NONE = 0, y._JOIN = 1, y._READ = 2, y._WRITE = 4, y._PRES = 8, y._APPROVE = 16, y._SHARE = 32, y._DELETE = 64, y._OWNER = 128, y._BITMASK = y._JOIN | y._READ | y._WRITE | y._PRES | y._APPROVE | y._SHARE | y._DELETE | y._OWNER, y._INVALID = 1048576, y._checkFlag = function (e, t, n) {
      if (["given", "want", "mode"].includes(t = t || "mode")) return 0 != (e[t] & n);
      throw new Error("Invalid AccessMode component '" + t + "'");
    }, y.decode = function (e) {
      if (!e) return null;
      if ("number" == typeof e) return e & y._BITMASK;
      if ("N" === e || "n" === e) return y._NONE;
      ...
      if (null === e || e === y._INVALID) return null;
      if (e === y._NONE) return "N";
      ...
      if ("+" == n || "-" == n) {
        for (var i = e, s = t.split(/([-+])/), r = 1; r < s.length - 1; r += 2) {
          n = s[r];
          var o = y.decode(s[r + 1]);
          if (o == y._INVALID) return e;
          null != o && ("+" === n ? i |= o : "-" === n && (i &= ~o));
        }
      ...
      toString: function () {
        return '{"mode": "' + y.encode(this.mode) + '", "given": "' + y.encode(this.given) + '", "want": "' + y.encode(this.want) + '"}';
      },
      jsonHelper: function () {
        return {
          mode: y.encode(this.mode),
          given: y.encode(this.given),
          want: y.encode(this.want)
        };
      },
      setMode: function (e) {
        return this.mode = y.decode(e), this;
      },
      updateMode: function (e) {
        return this.mode = y.update(this.mode, e), this;
      },
      getMode: function () {
        return y.encode(this.mode);
      },
      setGiven: function (e) {
        return this.given = y.decode(e), this;
      },
      updateGiven: function (e) {
        return this.given = y.update(this.given, e), this;
      },
      getGiven: function () {
        return y.encode(this.given);
      },
      setWant: function (e) {
        return this.want = y.decode(e), this;
      },
      updateWant: function (e) {
        return this.want = y.update(this.want, e), this;
      },
      getWant: function () {
        return y.encode(this.want);
      },
      getMissing: function () {
        return y.encode(this.want & ~this.given);
      },
      getExcessive: function () {
        return y.encode(this.given & ~this.want);
      },
      updateAll: function (e) {
        return e && (this.updateGiven(e.given), this.updateWant(e.want), this.mode = this.given & this.want), this;
      },
      isOwner: function (e) {
        return y._checkFlag(this, e, y._OWNER);
      },
      isPresencer: function (e) {
        return y._checkFlag(this, e, y._PRES);
      },
      isMuted: function (e) {
        return !this.isPresencer(e);
      },
      isJoiner: function (e) {
        return y._checkFlag(this, e, y._JOIN);
      },
      isReader: function (e) {
        return y._checkFlag(this, e, y._READ);
      },
      isWriter: function (e) {
        return y._checkFlag(this, e, y._WRITE);
      },
      isApprover: function (e) {
        return y._checkFlag(this, e, y._APPROVE);
      },
      isAdmin: function (e) {
        return this.isOwner(e) || this.isApprover(e);
      },
      isSharer: function (e) {
        return this.isAdmin(e) || y._checkFlag(this, e, y._SHARE);
      },
      isDeleter: function (e) {
        return y._checkFlag(this, e, y._DELETE);
      }
    };

    var x = function (e, t) {
      this._tinode = null, this.name = e, this.created = null, this.updated = null, this.touched = null, this.acs = new y(null), this.private = null, this.public = null, this._users = {}, this._queuedSeqId = 268435455, this._maxSeq = 0, this._minSeq = 0, this._noEarlierMsgs = !1, this._maxDel = 0, this._tags = [], this._credentials = [], this._messages = function (e) {
        var t = [];

        function n(t, n, i) {
          for (var s = 0, r = n.length - 1, o = 0, a = 0, c = !1; s <= r;) if ((a = e(n[o = (s + r) / 2 | 0], t)) < 0) s = o + 1;else {
            if (!(a > 0)) {
              c = !0;
              break;
            }
        ...
        return e = e || function (e, t) {
          ...
          put: function () {
            ...
            for (var r in e = 1 == arguments.length && Array.isArray(arguments[0]) ? arguments[0] : arguments) i = e[r], (s = t).splice(n(i, s, !1), 0, i);
          },
          delAt: function (e) {
            var n = t.splice(e, 1);
            if (n && n.length > 0) return n[0];
          },
          delRange: function (e, n) {
            return t.splice(e, n - e);
          },
          size: function () {
            return t.length;
          },
          ...
          forEach: function (e, n, i, s) {
            n |= 0, i = i || t.length;

            for (var r = n; r < i; r++) e.call(s, t[r], r);
          },
          find: function (e, i) {
            return n(e, t, !i);
          }
    ...
    x.prototype = {
      ...
      subscribe: function (e, t) {
        var n = this;
        return this._subscribed ? Promise.resolve(this) : this._tinode.subscribe(this.name || "new", e, t).then(function (e) {
          if (e.code >= 300) return e;

          if (n._subscribed = !0, n.acs = e.params && e.params.acs ? e.params.acs : n.acs, n._new) {
            if (n._new = !1, n.name = e.topic, n.created = e.ts, n.updated = e.ts, n._cachePutSelf(), "me" != n.name && "fnd" != n.name) {
              var i = n._tinode.getMeTopic();
            ...
            t && t.desc && (t.desc._noForwarding = !0, n._processMetaDesc(t.desc));
          }
      ...
      publishMessage: function (e) {
        var t = this;
        if (!this._subscribed) return Promise.reject(new Error("Cannot publish on inactive topic"));

        if (s.hasAttachments(e.content) && !e.head.attachments) {
          var n = [];
          s.attachments(e.content, function (e) {
            n.push(e.ref);
          }), e.head.attachments = n;
        }

        return e._sending = !0, e._failed = !1, this._tinode.publishMessage(e).then(function (n) {
          return e._sending = !1, e.seq = n.params.seq, e.ts = n.ts, t._routeData(e), n;
        }).catch(function (n) {
          log("Message rejected by the server", n), e._sending = !1, e._failed = !0, t.onData && t.onData();
        });
      },
      publishDraft: function (e, t) {
        var n = this;
        if (!t && !this._subscribed) return Promise.reject(new Error("Cannot publish on inactive topic"));

        var i = e.seq || this._getQueuedSeqId();

        return e._noForwarding || (e._noForwarding = !0, e.seq = i, e.ts = new Date(), e.from = this._tinode.getCurrentUserID(), e.noecho = !0, this._messages.put(e), this.onData && this.onData(e)), (t || Promise.resolve()).then(function () {
          return e._cancelled ? {
            code: 300,
            text: "cancelled"
          } : n.publishMessage(e);
        }, function (t) {
          log("Message draft rejected by the server", t), e._sending = !1, e._failed = !0, n._messages.delAt(n._messages.find(e)), n.onData && n.onData();
        });
      },
      leave: function (e) {
        var t = this;
        return this._subscribed || e ? this._tinode.leave(this.name, e).then(function (n) {
          return t._resetSub(), e && t._gone(), n;
      ...
      getMessagesPage: function (e, t) {
        var n = this,
            i = this.startMetaQuery();
        t ? i.withLaterData(e) : i.withEarlierData(e);
        var s = this.getMeta(i.build());
        return t || (s = s.then(function (e) {
          e && e.params && !e.params.count && (n._noEarlierMsgs = !0);
        })), s;
      },
      setMeta: function (e) {
        var t = this;
        return e.tags && (e.tags = function (e) {
          var t = [];
          ...
          return 0 == t.length && t.push(S.DEL_CHAR), t;
      ...
      archive: function (e) {
        return this.private && this.private.arch == e ? Promise.resolve(e) : this.setMeta({
          desc: {
            private: {
              arch: !!e || S.DEL_CHAR
            }
      ...
      delMessages: function (e, t) {
        var n = this;
        if (!this._subscribed) return Promise.reject(new Error("Cannot delete messages in inactive topic"));
        e.sort(function (e, t) {
          return e.low < t.low || e.low == t.low && (!t.hi || e.hi >= t.hi);
        });
        var i = e.reduce(function (e, t) {
          return t.low < 268435455 && (!t.hi || t.hi < 268435455 ? e.push(t) : e.push({
            low: t.low,
            hi: n._maxSeq + 1
          })), e;
        }, []);
        return (i.length > 0 ? this._tinode.delMessages(this.name, i, t) : Promise.resolve({
          params: {
            del: 0
          }
        })).then(function (t) {
          return t.params.del > n._maxDel && (n._maxDel = t.params.del), e.map(function (e) {
            e.hi ? n.flushMessageRange(e.low, e.hi) : n.flushMessage(e.low);
          }), n.onData && n.onData(), t;
        });
      },
      ...
      delMessagesList: function (e, t) {
        ...
        var n = e.reduce(function (e, t) {
          if (0 == e.length) e.push({
            low: t
          });else {
            var n = e[e.length - 1];
            !n.hi && t != n.low + 1 || t > n.hi ? e.push({
              low: t
      ...
      delTopic: function () {
        var e = this;
        return this._tinode.delTopic(this.name).then(function (t) {
          return e._resetSub(), e._gone(), t;
        });
      },
      delSubscription: function (e) {
        var t = this;
        return this._subscribed ? this._tinode.delSubscription(this.name, e).then(function (n) {
          return delete t._users[e], t.onSubsUpdated && t.onSubsUpdated(Object.keys(t._users)), n;
        }) : Promise.reject(new Error("Cannot delete subscription in inactive topic"));
      },
      note: function (e, t) {
        var n = this._users[this._tinode.getCurrentUserID()];

        n ? (!n[e] || n[e] < t) && (this._subscribed ? this._tinode.note(this.name, e, t) : this._tinode.logger("Not sending {note} on inactive topic"), n[e] = t) : this._tinode.logger("note(): user not found " + this._tinode.getCurrentUserID());

        var i = this._tinode.getMeTopic();

        i && i.setMsgReadRecv(this.name, e, t);
      },
      noteRecv: function (e) {
        this.note("recv", e);
      },
      ...
      noteKeyPress: function () {
        this._subscribed ? this._tinode.noteKeyPress(this.name) : this._tinode.logger("Cannot send notification in inactive topic");
      },
      userDesc: function (e) {
        var t = this._cacheGetUser(e);

        if (t) return t;
      },
      p2pPeerDesc: function () {
        if ("p2p" == this.getType()) return this._users[this.name];
      },
      subscribers: function (e, t) {
        var n = e || this.onMetaSub;
        if (n) for (var i in this._users) n.call(t, this._users[i], i, this._users);
      },
      tags: function () {
      ...
      messages: function (e, t, n, i) {
        var s = e || this.onData;

        if (s) {
          var r = "number" == typeof t ? this._messages.find({
            seq: t
          }) : void 0,
              o = "number" == typeof n ? this._messages.find({
            seq: n
          }, !0) : void 0;
          -1 != r && -1 != o && this._messages.forEach(s, r, o, i);
        }
      },
      ...
      msgReceiptCount: function (e, t) {
        ...
        if (t > 0) {
          var i = this._tinode.getCurrentUserID();

          for (var s in this._users) {
            var r = this._users[s];
            r.user !== i && r[e] >= t && n++;
          }
        }
      ...
      msgHasMoreMessages: function (e) {
        return e ? this.seq > this._maxSeq : this._minSeq > 1 && !this._noEarlierMsgs;
      },
      isNewMessage: function (e) {
        return this._maxSeq <= e;
      },
      flushMessage: function (e) {
        var t = this._messages.find({
          seq: e
        });

        return t >= 0 ? this._messages.delAt(t) : void 0;
      },
      ...
      cancelSend: function (e) {
        ...
        if (t >= 0) {
          var n = this._messages.getAt(t),
              i = this.msgStatus(n);

          if (1 == i || 3 == i) return n._cancelled = !0, this._messages.delAt(t), this.onData && this.onData(), !0;
        }

        return !1;
      },
      getType: function () {
        return S.topicType(this.name);
      },
      ...
      msgStatus: function (e) {
        var t = 0;
        return this._tinode.isMe(e.from) ? e._sending ? t = 2 : e._failed ? t = 3 : e.seq >= 268435455 ? t = 1 : this.msgReadCount(e.seq) > 0 ? t = 6 : this.msgRecvCount(e.seq) > 0 ? t = 5 : e.seq > 0 && (t = 4) : t = 7, t;
      },
      _routeData: function (e) {
        e.content && ((!this.touched || this.touched < e.ts) && (this.touched = e.ts), e._noForwarding || this._messages.put(e)), e.seq > this._maxSeq && (this._maxSeq = e.seq), (e.seq < this._minSeq || 0 == this._minSeq) && (this._minSeq = e.seq), this.onData && this.onData(e);

        var t = this._tinode.getMeTopic();

        t && t.setMsgReadRecv(this.name, this._tinode.isMe(e.from) ? "read" : "msg", e.seq, e.ts);
      },
      _routeMeta: function (e) {
        e.desc && (this._lastDescUpdate = e.ts, this._processMetaDesc(e.desc)), e.sub && e.sub.length > 0 && (this._lastSubsUpdate = e.ts, this._processMetaSub(e.sub)), e.del && this._processDelMessages(e.del.clear, e.del.delseq), e.tags && this._processMetaTags(e.tags), e.cred && this._processMetaCreds(e.cred), this.onMeta && this.onMeta(e);
      },
      _routePres: function (e) {
        var t;

        switch (e.what) {
          case "del":
            this._processDelMessages(e.clear, e.delseq);

            break;

          case "on":
          case "off":
            (t = this._users[e.src]) ? t.online = "on" == e.what : this._tinode.logger("Presence update for an unknown user", this.name, e.src);
            break;

          case "acs":
            if (t = this._users[e.src]) t.acs.updateAll(e.dacs), this._processMetaSub([{
              user: e.src,
              updated: new Date(),
              acs: t.acs
            }]);else {
              var n = new y().updateAll(e.dacs);
              n && n.mode != y._NONE && ((t = this._cacheGetUser(e.src)) ? t.acs = n : (t = {
                user: e.src,
                acs: n
          ...
          default:
            this._tinode.logger("Ignored presence update", e.what);

        }

        this.onPres && this.onPres(e);
      },
      _routeInfo: function (e) {
        if ("kp" !== e.what) {
          var t = this._users[e.from];

          if (t && (t[e.what] = e.seq, t.recv < t.read && (t.recv = t.read)), this._tinode.isMe(e.from)) {
            var n = this._tinode.getMeTopic();

            n && n.setMsgReadRecv(e.topic, e.what, e.seq);
          }
        }
      ...
      _processMetaDesc: function (e) {
        if ("p2p" == this.getType() && delete e.defacs, g(this, e), "string" == typeof this.created && (this.created = new Date(this.created)), "string" == typeof this.updated && (this.updated = new Date(this.updated)), "string" == typeof this.touched && (this.touched = new Date(this.touched)), "me" !== this.name && !e._noForwarding) {
          var t = this._tinode.getMeTopic();
      ...
      _processMetaSub: function (e) {
        for (var t in e) {
          var n = e[t];
          n.updated = new Date(n.updated), n.deleted = n.deleted ? new Date(n.deleted) : null;
          var i = null;
          n.deleted ? (delete this._users[n.user], i = n) : (this._tinode.isMe(n.user) && n.acs && this._processMetaDesc({
            updated: n.updated || new Date(),
            touched: n.updated,
            acs: n.acs
          }), i = this._updateCachedUser(n.user, n)), this.onMetaSub && this.onMetaSub(i);
        }

        this.onSubsUpdated && this.onSubsUpdated(Object.keys(this._users));
      },
      _processMetaTags: function (e) {
        1 == e.length && e[0] == S.DEL_CHAR && (e = []), this._tags = e, this.onTagsUpdated && this.onTagsUpdated(e);
      },
      _processMetaCreds: function (e) {},
      _processDelMessages: function (e, t) {
        this._maxDel = Math.max(e, this._maxDel), this.clear = Math.max(e, this.clear);
        var n = this,
            i = 0;
        Array.isArray(t) && t.map(function (e) {
          if (e.hi) for (var t = e.low; t < e.hi; t++) i++, n.flushMessage(t);else i++, n.flushMessage(e.low);
        }), i > 0 && this.onData && this.onData();
      },
      ...
      _gone: function () {
        this._messages.reset(), this._users = {}, this.acs = new y(null), this.private = null, this.public = null, this._maxSeq = 0, this._minSeq = 0, this._subscribed = !1;
      ...
      _updateCachedUser: function (e, t) {
        var n = this._cacheGetUser(e);

        return n = g(n || {}, t), this._cachePutUser(e, n), v(this._users, e, n);
      },
    ...
    D.prototype = Object.create(x.prototype, {
      _processMetaSub: {
        value: function (e) {
          ...
          for (var n in e) {
            ...
            if ("fnd" != s && "me" != s) {
              i.updated = new Date(i.updated), i.touched = i.touched ? new Date(i.touched) : void 0, i.deleted = i.deleted ? new Date(i.deleted) : null;
              var r = null;
              if (i.deleted) r = i, delete this._contacts[s];else if (i.acs && !i.acs.isJoiner()) (r = i).deleted = new Date(), delete this._contacts[s];else if (void 0 !== i.seq && (i.seq = 0 | i.seq, i.recv = 0 | i.recv, i.read = 0 | i.read, i.unread = i.seq - i.read), i.seen && i.seen.when && (i.seen.when = new Date(i.seen.when)), r = v(this._contacts, s, i), "p2p" == S.topicType(s) && this._cachePutUser(s, r), !i._noForwarding) {
                var o = this._tinode.getTopic(s);

                o && (i._noForwarding = !0, o._processMetaDesc(i));
              }
              t++, this.onMetaSub && this.onMetaSub(r);
            }
          }

          this.onSubsUpdated && this.onSubsUpdated(Object.keys(this._contacts), t);
        },
        enumerable: !0,
        configurable: !0,
        writable: !1
      ...
      _processMetaCreds: {
        value: function (e, t) {
          var n = this;
          1 == e.length && e[0] == S.DEL_CHAR && (e = []), t ? e.map(function (e) {
            if (e.val) {
              var t = n._credentials.findIndex(function (t) {
                return t.meth == e.meth && t.val == e.val;
              });

              t < 0 ? (e.done || (t = n._credentials.findIndex(function (t) {
                return t.meth == e.meth && !t.done;
              })) >= 0 && n._credentials.splice(t, 1), n._credentials.push(e)) : n._credentials[t].done = e.done;
            } else if (e.resp) {
              var i = n._credentials.findIndex(function (t) {
                return t.meth == e.meth && !t.done;
              });

              i >= 0 && (n._credentials[i].done = !0);
            }
          }) : this._credentials = e, this.onCredsUpdated && this.onCredsUpdated(this._credentials);
        },
        enumerable: !0,
        configurable: !0,
        writable: !1
        ...
        value: function (e) {
          ...
          if (t) {
            switch (e.what) {
              ...
              case "off":
                t.online && (t.online = !1, t.seen ? t.seen.when = new Date() : t.seen = {
                  when: new Date()
                });
                break;

              case "msg":
                t.touched = new Date(), t.seq = 0 | e.seq, t.unread = t.seq - t.read;
                break;

              case "upd":
                this.getMeta(this.startMetaQuery().withLaterOneSub(e.src).build());
                break;

              case "acs":
                t.acs ? t.acs.updateAll(e.dacs) : t.acs = new y().updateAll(e.dacs), t.touched = new Date();
                break;
              ...
              case "recv":
                t.recv = t.recv ? Math.max(t.recv, e.seq) : 0 | e.seq;
                break;

              case "read":
                t.read = t.read ? Math.max(t.read, e.seq) : 0 | e.seq, t.unread = t.seq - t.read;
                break;

              case "gone":
                delete this._contacts[e.src];
                break;
            ...
            var n = new y(e.dacs);
            if (!n || n.mode == y._INVALID) return void this._tinode.logger("Invalid access mode update", e.src, e.dacs);
            if (n.mode == y._NONE) return void this._tinode.logger("Removing non-existent subscription", e.src, e.dacs);
          ...
          } else "tags" == e.what && this.getMeta(this.startMetaQuery().withTags().build());
      ...
      delCredential: {
        value: function (e, t) {
          var n = this;
          return this._subscribed ? this._tinode.delCredential(this.name, e, t).then(function (i) {
            var s = n._credentials.findIndex(function (n) {
              return n.meth == e && n.val == t;
            });

            return s > -1 && n._credentials.splice(s, 1), n.onCredsUpdated && n.onCredsUpdated(n._credentials), i;
          }) : Promise.reject(new Error("Cannot delete credential in inactive 'me' topic"));
        },
        enumerable: !0,
        configurable: !0,
        writable: !1
      ...
      contacts: {
        value: function (e, t, n) {
          var i = e || this.onMetaSub;
          if (i) for (var s in this._contacts) (t || this._contacts[s] && this._contacts[s].acs && this._contacts[s].acs.isJoiner()) && i.call(n, this._contacts[s], s, this._contacts);
        },
        enumerable: !0,
        configurable: !0,
        writable: !0
      ...
      setMsgReadRecv: {
        value: function (e, t, n, i) {
          ...
          if (r) {
            switch (n |= 0, r.seq = 0 | r.seq, r.read = 0 | r.read, r.recv = 0 | r.recv, t) {
              case "recv":
                s = r.recv, r.recv = Math.max(r.recv, n), o = s != r.recv;
                break;

              case "read":
                s = r.read, r.read = Math.max(r.read, n), o = s != r.read;
                break;
      ...
      isArchived: {
        value: function (e) {
          var t = this._contacts[e];
          return t ? !(!t.private || !t.private.arch) : null;
        },
        enumerable: !0,
        configurable: !0,
        writable: !0
    ...
    E.prototype = Object.create(x.prototype, {
      _processMetaSub: {
        value: function (e) {
          ...
          for (var n in this._contacts = {}, e) {
            var i = e[n],
                s = i.topic ? i.topic : i.user;
            i.updated = new Date(i.updated), i.seen && i.seen.when && (i.seen.when = new Date(i.seen.when)), i = v(this._contacts, s, i), t++, this.onMetaSub && this.onMetaSub(i);
          }

          t > 0 && this.onSubsUpdated && this.onSubsUpdated(Object.keys(this._contacts));
        },
        enumerable: !0,
        configurable: !0,
        writable: !1
      ...
      setMeta: {
        value: function (e) {
          var t = this;
          return Object.getPrototypeOf(E.prototype).setMeta.call(this, e).then(function () {
            Object.keys(t._contacts).length > 0 && (t._contacts = {}, t.onSubsUpdated && t.onSubsUpdated([]));
          });
        },
        enumerable: !0,
        configurable: !0,
      ...
      contacts: {
        value: function (e, t) {
          var n = e || this.onMetaSub;
          if (n) for (var i in this._contacts) n.call(t, this._contacts[i], i, this._contacts);
        },
        enumerable: !0,
        configurable: !0,
        writable: !0
    ...
    var A = function (e) {
      this._tinode = e, this._apiKey = e._apiKey, this._authToken = e.getAuthToken(), this._msgId = e.getNextUniqueId(), this.xhr = _(), this.toResolve = null, this.toReject = null, this.onProgress = null, this.onSuccess = null, this.onFailure = null;
    };

    A.prototype = {
      uploadWithBaseUrl: function (e, t, n, i, s) {
        var r = this;
        ...
        if (e) {
          if (0 != e.indexOf("http://") && 0 != e.indexOf("https://")) throw new Error("Invalid base URL '" + e + "'");
          c = e + c;
        }

        this.xhr.open("POST", c, !0), this.xhr.setRequestHeader("X-Tinode-APIKey", this._apiKey), this.xhr.setRequestHeader("X-Tinode-Auth", "Token " + this._authToken.token);
        var u = new Promise(function (e, t) {
          r.toResolve = e, r.toReject = t;
        });
        this.onProgress = n, this.onSuccess = i, this.onFailure = s, this.xhr.upload.onprogress = function (e) {
          e.lengthComputable && o.onProgress && o.onProgress(e.loaded / e.total);
        }, this.xhr.onload = function () {
          var e;

          try {
            e = JSON.parse(this.response, m);
          } catch (t) {
            o._tinode.logger("Invalid server response in LargeFileHelper", this.response);
          }

          this.status >= 200 && this.status < 300 ? (o.toResolve && o.toResolve(e.ctrl.params.url), o.onSuccess && o.onSuccess(e.ctrl)) : this.status >= 400 ? (o.toReject && o.toReject(new Error(e.ctrl.text + " (" + e.ctrl.code + ")")), o.onFailure && o.onFailure(e.ctrl)) : o._tinode.logger("Unexpected server response status", this.status, this.response);
        }, this.xhr.onerror = function (e) {
          o.toReject && o.toReject(new Error("failed")), o.onFailure && o.onFailure(null);
        }, this.xhr.onabort = function (e) {
          o.toReject && o.toReject(new Error("upload cancelled by user")), o.onFailure && o.onFailure(null);
        };

        try {
          var h = new FormData();
          h.append("file", t), h.set("id", this._msgId), this.xhr.send(h);
        } catch (l) {
          this.toReject && this.toReject(l), this.onFailure && this.onFailure(null);
        }

        return u;
      },
      upload: function (e, t, n, i) {
        return this.uploadWithBaseUrl(void 0, e, t, n, i);
      },
      download: function (e, t, n, i) {
        var s = this;
        if (/^\s*([a-z][a-z0-9+.-]*:|\/\/)/im.test(e)) throw new Error("The URL '" + e + "' must be relative, not absolute");
        if (!this._authToken) throw new Error("Must authenticate first");
        var r = this;
        this.xhr.open("GET", e, !0), this.xhr.setRequestHeader("X-Tinode-APIKey", this._apiKey), this.xhr.setRequestHeader("X-Tinode-Auth", "Token " + this._authToken.token), this.xhr.responseType = "blob", this.onProgress = i, this.xhr.onprogress = function (e) {
          r.onProgress && r.onProgress(e.loaded);
        };
        var o = new Promise(function (e, t) {
          s.toResolve = e, s.toReject = t;
        });
        this.xhr.onload = function () {
          if (200 == this.status) {
            var e = document.createElement("a");
            e.href = window.URL.createObjectURL(new Blob([this.response], {
              type: n
            })), e.style.display = "none", e.setAttribute("download", t), document.body.appendChild(e), e.click(), document.body.removeChild(e), window.URL.revokeObjectURL(e.href), r.toResolve && r.toResolve();
          } else if (this.status >= 400 && r.toReject) {
            var i = new FileReader();
            i.onload = function () {
              try {
                var e = JSON.parse(this.result, m);
                r.toReject(new Error(e.ctrl.text + " (" + e.ctrl.code + ")"));
              } catch (t) {
                r._tinode.logger("Invalid server response in LargeFileHelper", this.result), r.toReject(t);
              }
            }, i.readAsText(this.response);
          }
        }, this.xhr.onerror = function (e) {
    ...
    var R = function e(t, n) {
      this.status = e.STATUS_NONE, this.topic = t, this.content = n;
    };

    R.STATUS_NONE = 0, R.STATUS_QUEUED = 1, R.STATUS_SENDING = 2, R.STATUS_FAILED = 3, R.STATUS_SENT = 4, R.STATUS_RECEIVED = 5, R.STATUS_READ = 6, R.STATUS_TO_ME = 7, (R.prototype = {
      toJSON: function () {},
      fromJSON: function (e) {}
    }).constructor = R, i.exports = S, i.exports.Drafty = s;
  }.call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}), i = i.exports;
});
