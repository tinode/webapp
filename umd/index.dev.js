...
/*!***********************!*\
  !*** ./src/config.js ***!
  \***********************/
/*! exports provided: APP_NAME, API_KEY, KNOWN_HOSTS, DEFAULT_HOST, KEYPRESS_DELAY, RECEIVED_DELAY, READ_DELAY, MIN_TAG_LENGTH, MEDIA_BREAKPOINT, REM_SIZE, AVATAR_SIZE, BROKEN_IMAGE_SIZE, MESSAGES_PAGE, MAX_INBAND_ATTACHMENT_SIZE, MAX_EXTERN_ATTACHMENT_SIZE, MAX_IMAGE_DIM */
...
var ContactsView = function (_React$Component) {
  ...
  _createClass(ContactsView, [{
    ...
    value: function render() {
      ...
      var archivedCount = this.state.archivedCount;
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_1__["FormattedHTMLMessage"], {
      ...
      }), archivedCount > 0 ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_1__["FormattedMessage"], {
...
var EditAccountView = function (_React$Component) {
  ...
  _createClass(EditAccountView, [{
    ...
    value: function handleFullNameUpdate(fn) {
      ...
      this.props.onUpdateAccount(undefined, Object(_lib_utils_js__WEBPACK_IMPORTED_MODULE_8__["vcard"])(fn, this.state.avatar));
    }
  }, {
    ...
    value: function handleImageChanged(img) {
      ...
      this.props.onUpdateAccount(undefined, Object(_lib_utils_js__WEBPACK_IMPORTED_MODULE_8__["vcard"])(this.state.fullName, img));
    }
  }, {
...
/* harmony import */ var _lib_utils_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../lib/utils.js */ "./src/lib/utils.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
  ...
  _createClass(InfoView, [{
    ...
    value: function handleFullNameUpdate(fn) {
      ...
      if (this.state.fullName !== fn) {
        ...
        this.props.onTopicDescUpdate(this.props.topic, Object(_lib_utils_js__WEBPACK_IMPORTED_MODULE_14__["vcard"])(fn, this.state.avatar), null);
      }
    }
  }, {
    ...
    value: function handleImageChanged(img) {
      ...
      this.props.onTopicDescUpdate(this.props.topic, Object(_lib_utils_js__WEBPACK_IMPORTED_MODULE_14__["vcard"])(this.state.fullName, img), null);
    }
  }, {
    key: "handleMuted",
...
var TinodeWeb = function (_React$Component) {
  ...
  _createClass(TinodeWeb, [{
    ...
    value: function defaultTopicContextMenu(topicName) {
      ...
      } : null, subscribed ? 'messages_clear' : null, subscribed && deleter ? 'messages_clear_hard' : null, subscribed ? muted ? 'topic_unmute' : 'topic_mute' : null, subscribed ? blocked ? 'topic_unblock' : 'topic_block' : null, subscribed && !archived ? 'topic_archive' : null, 'topic_delete'];
    }
  }, {
