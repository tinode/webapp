  ...
  if (el) {
    ...
    switch (style) {
      ...
      case 'BN':
        ...
        attr['data-title'] = (react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.map(values, function (child) {
          return child;
        }) || [attr.name]).join('');
        break;
