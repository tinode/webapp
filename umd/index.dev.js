...
var ContactsView = function (_React$Component) {
  ...
  function ContactsView(props) {
    ...
    _this.handleAction = _this.handleAction.bind(_assertThisInitialized(_assertThisInitialized(_this)));
...
/* harmony import */ var react_intl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-intl */ "react-intl");
/* harmony import */ var react_intl__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_intl__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var tinode_sdk__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tinode-sdk */ "./node_modules/tinode-sdk/umd/tinode.prod.js");
  ...
  _createClass(InfoView, [{
    ...
    value: function handleFullNameUpdate(fn) {
      ...
      if (this.state.fullName !== fn) {
        ...
        this.props.onTopicDescUpdate(this.props.topic, Object(_lib_utils_js__WEBPACK_IMPORTED_MODULE_14__["vcard"])(fn, null), null);
      }
    }
  }, {
    ...
    value: function handleImageChanged(img) {
      ...
      this.props.onTopicDescUpdate(this.props.topic, Object(_lib_utils_js__WEBPACK_IMPORTED_MODULE_14__["vcard"])(null, img), null);
    }
  }, {
    key: "handleMuted",
...
/* harmony import */ var tinode_sdk__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tinode-sdk */ "./node_modules/tinode-sdk/umd/tinode.prod.js");
...
var TinodeWeb = function (_React$Component) {
  ...
  function TinodeWeb(props) {
    ...
    _this.handleShowArchive = _this.handleShowArchive.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    ...
    _this.handleContextMenuAction = _this.handleContextMenuAction.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(TinodeWeb, [{
    ...
    value: function requestPushToken() {
      ...
      this.fbPush.getToken().then(function (refreshedToken) {
        if (refreshedToken != _this18.state.firebaseToken) {
          _this18.tinode.setDeviceToken(refreshedToken, true);
    ...
    value: function handlePasswordResetRequest(method, value) {
      ...
      this.tinode.connect().then(function () {
        return _this26.tinode.requestResetAuthSecret('basic', method, value);
      }).catch(function (err) {
    ...
    value: function handleResetPassword(scheme, newPassword, token) {
      ...
      if (!token) {
        ...
        this.tinode.connect().then(function () {
          return _this27.tinode.updateAccountBasic(null, null, newPassword, {
            token: token
          });
        }).catch(function (err) {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var tinode_sdk__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tinode-sdk */ "./node_modules/tinode-sdk/umd/tinode.prod.js");
