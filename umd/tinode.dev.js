  ...
  _updateDeletedRanges: function() {
    ...
    this._messages.forEach((data) => {
      ...
      if (data.seq == (prev.hi || prev.seq) + 1) {
        console.log("No new gap. Replace previous with current");
      ...
      console.log("Previous is not a gap. Create a new gap.");
      ranges.push(prev);
    });
