...
Topic.prototype = {
  ...
  _updateReadRecv: function(what, seq, ts) {
    ...
    switch (what) {
      ...
      case 'msg':
        ...
        if (!this.touched || this.touched < ts) {
          console.log("touched_1", this.name, this.touched, ts);
          this.touched = ts;
        }
    ...
    if (this.seq < this.recv) {
      this.seq = this.recv;
      if (!this.touched || this.touched < ts) {
        console.log("touched_2", this.name, this.touched, ts);
        this.touched = ts;
      }
      doUpdate = true;
    }
  ...
  _routeData: function(data) {
    if (data.content) {
      if (!this.touched || this.touched < data.ts) {
        console.log("touched_3", this.name, this.touched, data.ts);
    ...
    for (let idx in subs) {
      ...
      if (!sub.deleted) {
        ...
        if (this._tinode.isMe(sub.user) && sub.acs) {
          console.log("touched_4", this.name, this.touched, sub.updated);
          this._processMetaDesc({
            updated: sub.updated,
            touched: sub.updated,
            acs: sub.acs
          });
          console.log("touched_4.1", this.name, this.touched, sub.updated);
        }
  ...
  _updateReceived: function(seq, act) {
    console.log("touched_5", this.name, this.touched, new Date());
    ...
    value: function(subs) {
      ...
      subs.forEach((sub) => {
        ...
        if (sub.deleted) {
          ...
          var t = this._tinode.getTopic(topicName);
          console.log("touched_6", t.name, t.touched, sub.touched);
          cont = mergeObj(this._tinode.getTopic(topicName), sub);
          console.log("touched_6.1", t.name, t.touched, cont.touched);
      ...
      if (cont) {
        switch (pres.what) {
          ...
          case 'acs': // access mode changed
            ...
            console.log("touched_7", pres.src, cont.touched, new Date());
            break;
          case 'ua':
            // user agent changed.
            cont.seen = {
