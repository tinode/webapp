...
var _finalizeMsg = new WeakMap();

var _isSub = new WeakMap();
...
class CBuffer {
  constructor(compare_, unique_, isSub_, finalizeMsg_) {
    ...
    _classPrivateFieldInitSpec(this, _finalizeMsg, {
      writable: true,
      value: undefined
    });

    _classPrivateFieldInitSpec(this, _isSub, {
      writable: true,
      value: undefined
    });
    ...
    _classPrivateFieldSet(this, _finalizeMsg, finalizeMsg_ || (msg => msg));

    _classPrivateFieldSet(this, _isSub, isSub_ || (msg => false));
  }
  ...
  forEach(callback, startIdx, beforeIdx, context) {
    ...
    while (curIdx < beforeIdx && _classPrivateFieldGet(this, _isSub).call(this, this.buffer[curIdx])) {
      curIdx++;
    }

    let nextIdx = curIdx + 1;

    while (nextIdx < beforeIdx && _classPrivateFieldGet(this, _isSub).call(this, this.buffer[nextIdx])) {
      nextIdx++;
    }

    let prev = undefined;
    let cur = curIdx < beforeIdx ? _classPrivateFieldGet(this, _finalizeMsg).call(this, this.buffer[curIdx]) : undefined;
    let next = nextIdx < beforeIdx ? _classPrivateFieldGet(this, _finalizeMsg).call(this, this.buffer[nextIdx]) : undefined;
    ...
    while (curIdx < beforeIdx) {
      ...
      do nextIdx++; while (nextIdx < beforeIdx && _classPrivateFieldGet(this, _isSub).call(this, this.buffer[nextIdx]));

      prev = cur;
      cur = next;
      next = nextIdx < beforeIdx ? _classPrivateFieldGet(this, _finalizeMsg).call(this, this.buffer[nextIdx]) : undefined;
    }
  }
...
class Tinode {
  ...
  call(topicName, seq, evt, payload) {
    ...
    return _classPrivateMethodGet(this, _send, _send2).call(this, pkt, pkt.note.id);
  }
...
class Topic {
  ...
  _isReplacementMsg(pub) {
    if (typeof pub.head == 'undefined' || pub.head == null || typeof pub.head['replace-seq'] == 'undefined') {
      return false;
    }
