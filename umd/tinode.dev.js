...
Tinode.prototype = {
  ...
  oobNotification: function(topicName, seq, act) {
    console.log('notification', topicName, seq, act);
...
Topic.prototype = {
  ...
  _updateReceived: function(seq, act) {
    console.log("_updateReceived", seq, act, this.seq, );
  ...
  _refreshContact: {
    value: function(what, cont) {
      if (this.onContactUpdate) {
        console.log('_refreshContact', what, cont);
