export const __webpack_esm_ids__ = ["src_widgets_phone-country-selector_jsx"];
...
class PhoneCountrySelector extends react__WEBPACK_IMPORTED_MODULE_0__["default"].PureComponent {
  constructor(props) {
    super(props);
    this.countries = [];
    const {
    ...
    this.countries.forEach((c, idx) => {
      ...
      countries.push((0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxDEV)("li", {
        ...
        children: [(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxDEV)("span", {
          ...
          children: c.flag
        }, void 0, false), (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxDEV)("span", {
          className: "country",
          children: ["\xA0", c.name]
        }, void 0, true), (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxDEV)("span", {
          className: "dial-code",
          children: ["\xA0+", c.dial]
        }, void 0, true)]
      }, idx, true));
