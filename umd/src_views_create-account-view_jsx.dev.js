export const __webpack_esm_ids__ = ["src_views_create-account-view_jsx"];
...
class CreateAccountView extends react__WEBPACK_IMPORTED_MODULE_0__["default"].PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      login: '',
