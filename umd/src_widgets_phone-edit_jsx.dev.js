export const __webpack_esm_ids__ = ["src_widgets_phone-edit_jsx"];
...
class PhoneEdit extends react__WEBPACK_IMPORTED_MODULE_0__["default"].PureComponent {
  constructor(props) {
    super(props);
    this.codeMap = {};
  ...
  render() {
    return (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxDEV)(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_8__.Fragment, {
      children: [(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxDEV)("span", {
        className: "dial-code",
        onClick: this.showCountrySelector,
        children: [(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxDEV)("span", {
          className: "country-flag",
          children: [(0,_lib_strformat__WEBPACK_IMPORTED_MODULE_7__.flagEmoji)(this.state.countryCode), "\xA0"]
        }, void 0, true), "+", this.state.dialCode, "\xA0"]
      }, void 0, true), (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxDEV)("input", {
        type: "tel",
        ref: ref => {
          this.inputField = ref;
        },
